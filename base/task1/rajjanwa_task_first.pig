...
%default OUTPUT_TBL 'task_first_output'
...
records_with_days_diff = FOREACH joined_records GENERATE $0 as user_id ,ToDate($1) as created_on_ts,ToDate($2) as last_played ,(long)DaysBetween(ToDate(created_on_ts),ToDate(event_ts)) as days ;
